...
class AddressBookDuplicatesTests(unittest.TestCase):
    def setUp(self):
        ...
        person2 = Person("Jane Smith", "Data Scientist", "jane.smith@example.com", "janesmith", "Data Analytics", "XYZ Corp.", "TeamB", "Design")
        self.address_book.add_contact(person1)
        self.address_book.add_contact(person2)

    def test_add_contact_duplicate_email(self):
        person3 = Person("Alice Johnson", "Designer", "jane.smith@example.com", "alicej", "UI/UX Design", "Design Co.", "TeamB", "Design")
    ...
    def test_add_contact_unique_email(self):
        person4 = Person("Bob Brown", "Developer", "bob.brown@example.com", "bobb", "Web Development", "Web Dev Inc.", "TeamA", "Code")
