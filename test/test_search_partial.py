...
class TestAddressBookSearch(unittest.TestCase):
    def setUp(self):
        ...
        persons = [
            Person("John Doe", "Developer", "john.doe@example.com", "john", "", "Developer Co"),
            Person("Alice Smith", "Designer", "alice.smith@example.com", "alice1", "", "Design Co."),
            Person("Bob Johnson", "Manager", "bob.johnson@example.com", "bob_git", "", "Management Corp."),
            Person("Eve Doe", "Tester", "eve.doe@example.com", "eve", "", "Testing Ltd."),
        ]
