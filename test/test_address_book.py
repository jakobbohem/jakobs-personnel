...
class AddressBookTests(unittest.TestCase):
    def setUp(self):
        ...
        person1 = Person("John Doe", "Software Engineer", "john.doe@example.com", "johndoe", "Machine Learning", "ABC Inc.", "TeamA", "Code", False)
        person2 = Person("Jane Smith", "Data Scientist", "jane.smith@example.com", "janesmith", "Data Analytics", "XYZ Corp.", "TeamA", "Design", False)
